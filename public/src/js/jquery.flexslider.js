...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    var namespace = slider.vars.namespace,
        ...
        fade = slider.vars.animation === "fade" || slider.vars.animation === "fade2",
        fade2 = slider.vars.animation === "fade2",
        ...
        if (!fade) {
          ...
          if (!touch) {
            ...
            if (!fade2) {
              ...
              slider.slides.eq(target).css({"zIndex": 3}).animate({"opacity": 1}, slider.vars.animationSpeed, slider.vars.easing, slider.wrapup);
            }
    ...
    slider.wrapup = function(dimension) {
      ...
      if(fade2) {
        slider.slides.eq(slider.currentSlide).css({"zIndex": 1, "opacity": 0});
      }
      slider.animating = false;
      slider.currentSlide = slider.animatingTo;
